...
and implements `\Sly\NotificationPusher\Adapter\AdapterInterface` wich contains some required methods:
...
Feel free to observe [existant adapters](https://github.com/Ph3nol/NotificationPusher/tree/master/src/Sly/NotificationPusher/Adapter) for concrete example.
